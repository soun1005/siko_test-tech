...
const Nav = () => {
  ...
  return (
    <div className="min-h-full">
      {/* desktop nav */}
      <div className="container h-40 displayFlex-[space-between] text-basic text-white phone:hidden">
        <div>
          <img src={logo} alt="logo" />
        </div>

        {/* menu */}
        <ul className="w-10/12 displayFlex-[center] gap-20  screenXL:text-small screenXL:gap-8">
        ...
        <div>
          <button className="rounded-full border-solid border-[3px] py-2 px-10 displayFlex-[center] border-yellow hover:animate-vibrate screenXL:border-[2px] screenXL:py-2 screenXL:px-4">
